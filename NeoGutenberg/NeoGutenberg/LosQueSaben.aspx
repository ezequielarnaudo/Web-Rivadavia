<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LosQueSaben.aspx.cs" Inherits="NeoGutenberg.LosQueSaben" %>
...
<head>
    ...
    <link rel="stylesheet" href="losquesaben.css">
...
<body>
    ...
    <div class="container">
        <div class="container-fluid titulo-seccion">
            <h1 class="container-fluid titulo-seccion"><a class="lqs">LOS QUE SABEN</a></h1>
        </div>
        <div id="accordion">
            <div class="row">
                <div class="col-sm-9" id="editoresDesplegables" runat="server">
