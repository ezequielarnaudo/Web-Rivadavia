<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Politica.aspx.cs" Inherits="NeoGutenberg.Politica" %>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MMDT3VC"
    ...
    <div class="container">
        <div class="container-fluid titulo-seccion">
            <h1 class="container-fluid titulo-seccion"><a class="lqs" >POLITICA DE PRIVACIDAD</a></h1>
        </div>
        <div class="row">
             <div class="col-sm-9" style="font-family: Raleway, sans-serif;;">

                <P>El presente Política de Privacidad establece los términos en que <strong>mundoempresas.com.ar</strong> usa y protege
                ...
                <P><strong>mundoempresas.com.ar</strong> está altamente comprometido para cumplir con el compromiso de mantener su
                ...
                <P>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su
                    ...
                    web. También usted puede cambiar la configuración de su ordenador para declinar las cookies. Si se
                ...
                <P><strong>mundoempresas.com.ar</strong>  Se reserva el derecho de cambiar los términos de la presente Política de
